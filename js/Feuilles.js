...
// Configuration Firebase
        ...
        uploadBtn.addEventListener('click', async () => {
            ...
            try {
                ...
                uploadBtn.innerHTML = '<i class="fas fa-cloud-upload-alt"></i> Upload en cours...';
                ...
                if (result.success) {
                    ...
                    showMessage(`
                        ...
                        Photo uploadée avec succès ! <br>
                        <a href="${uploadedUrl}" target="_blank" rel="noopener" style="color: #059669; text-decoration: underline;">
                ...
                uploadBtn.innerHTML = '<i class="fas fa-cloud-upload-alt"></i> Envoyer la feuille signée';
                updateButtonStates();
            }
        });
